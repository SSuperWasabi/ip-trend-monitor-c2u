...
- 없으면 기본 수신자는 mail-to.txt 설정값(gitignore, 로컬 전용). 발송 전 확인하세요.

## 확인
```powershell
powershell -ExecutionPolicy Bypass -File .\gmail-draft.ps1 -To "you@example.com" -Subject "테스트 초안" -Body "본문 테스트"
```
